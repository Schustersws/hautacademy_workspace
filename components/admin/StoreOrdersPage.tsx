...
import { LayoutDashboard, Users, Calendar, Award, Building, GraduationCap, Gift, Wrench, Store, Clapperboard, Mail, MessageSquare, Settings, LogOut, HardHat, ShoppingCart } from 'lucide-react';
    ...
    <div className="min-h-screen bg-haut-dark text-white flex">
      ...
      <main className="flex-1 p-6">
        <div className="flex flex-col items-center justify-center text-center h-full bg-haut-surface rounded-lg border border-haut-border">
            ...
            <h1 className="text-3xl font-bold text-white mb-2">Gestão de Pedidos</h1>
